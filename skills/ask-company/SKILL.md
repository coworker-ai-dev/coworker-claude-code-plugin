...
2. Search organizational memory knowledge graph first (`om2_search`, `om2_entity_search`, `om2_enumerate`, `om2_cypher`), then use connector-specific search for live detail.
