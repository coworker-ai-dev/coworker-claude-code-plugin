...
description: Explore the company's OM2 organizational knowledge graph - people, projects, customers, and how they connect. Use for open-ended "what do we know about X", "how is A related to B", "what's the history of Y", "what are the themes around Z", and as a quick first-pass check on narrower work questions (a person's current project, a customer's status, what someone did this week). The tool map by question shape and the usage playbook are in this skill's body. If the om2_* tools aren't in this session, say so and follow company-data-first.
---
