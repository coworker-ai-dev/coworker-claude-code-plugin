<!-- Generated by scripts/sync-playbooks.py from the server-side GlobalSkill row `mcp-company-data-cascade`. Do not edit here: change the row, then re-run the script. -->
