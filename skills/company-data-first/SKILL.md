...
description: Routing for any request that touches this company's work - people, teams, customers, deals, projects, decisions, documents, meetings, messages, metrics, what someone is doing, what happened - or anything that lives in a connected work tool. Coworker MCP is the source of truth: search organizational memory (om2_* tools) before any connector, past-chat memory, or general knowledge, and call individual_context once before the first connector call. The routing table by question shape is in this skill's body. Applies from the first message; also says what to do if the Coworker tools are missing.
---
