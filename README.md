...
maintained server-side as `public."GlobalSkill"` rows (`coworker-company-data-search`,
`om2-memory-usage`, and whatever `skill_search` turns up for anything else) that Claude
